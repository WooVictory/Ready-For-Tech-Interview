...
<img src="/Users/woo/Library/Application Support/typora-user-images/image-20200709120747147.png" alt="image-20200709120747147" style="zoom:50%;" />

정리하면 중기 스케줄러에 의해 프로세스들이 CPU를 차지하려고 경쟁이 심해지면, `Swap out` 되어 메모리를 떠났다가 다시 `Swap in` 되어 메모리로 돌아온다는 것이다.

![image-20200709121400541](/Users/woo/Library/Application Support/typora-user-images/image-20200709121400541.png)
